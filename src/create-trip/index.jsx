...
function CreateTrip() {
  ...
  return (
    <div
      className="min-h-screen bg-cover bg-center bg-no-repeat px-5 sm:px-10 md:px-32 lg:px-56 xl:px-72 py-12"
      style={{ backgroundImage: "url('/Background-image-2.jpeg')" }}
    >
      <div className="w-full h-full bg-white bg-opacity-80 p-10 rounded-lg">
  ...
  onSelect={(place) => {
    ...
    console.log("LocationIQ Key:", import.meta.env.VITE_LOCATIONIQ_API_KEY)
  }}
/>
